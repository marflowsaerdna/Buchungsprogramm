...
"log_pw_subject_post" => "Jelszó",
"log_npw_msg" => "Here is your new password to log in to:",//
"log_npw_subject_pre" => "Az új",
"log_npw_subject_post" => "Jelszó",
...
//categories.php
"res_list" => "Kategóriák listája",
"res_edit" => "Szerkesztés",
"res_delete" => "Törlés",
"res_add_new" => "Új kategória hozzáadása",
"res_add" => "Kategória hozzáadása",
"res_edit_cat" => "Kategória szerkesztése",
"res_back" => "Back",
"res_name" => "Kategória neve",
"res_sequence" => "Sorrend",
"res_in_menu" => "in menu",
"res_text_color" => "Szöveg szín",
"res_background" => "Háttér",
"res_select_color" => "Szín kiválasztása",
"res_save" => "Kategória feltöltése",
"res_added" => "A kategóriát hozzáadtam",
"res_updated" => "A kategóriát feltöltöttem",
"res_deleted" => "A kategóriát töröltem",
"res_invalid_color" => "Color format invalid (#XXXXXX - X = HEX-value)",
"res_not_added" => "A kategóriát nem adtam hozzá!",
"res_not_updated" => "A kategóriát nem töltöttem fel!",
"res_not_deleted" => "A kategóriát nem töröltem!",
"res_nr" => "#",//
"res_repeat" => "Repeat",//
...
"usr_admin_functions" => "Adminisztrációs funkciók",
...
"not_all_day_event" => "Egésznapos esemény",
"not_mailer" => "postázó",
"not_subject" => "Subject",
"not_event_due_in" => "Későbbi események",
"not_due_in" => "Későbbiek",
"not_days" => "nap",
"not_date_time" => "Dátum / idő",
"not_title" => "Cím",
"not_sender" => "Küldő",
"not_venue" => "Helyszín",
"not_description" => "Leírás",
"not_resource" => "Kategória",
"not_open_calendar" => "Nyílt naptár",
