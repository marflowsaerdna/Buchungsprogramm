...
//categories.php
"res_list" => "Spis Kategorii",
"res_edit" => "Edytuj",
"res_delete" => "Usuń",
"res_add_new" => "Dodaj Nową Kategorię",
"res_add" => "Dodaj Kategorię",
"res_edit_cat" => "Edytuj Kategorię",
"res_back" => "Back",
"res_name" => "Nazwa Kategorii",
"res_sequence" => "Kolejność",
"res_in_menu" => "in menu",
"res_text_color" => "Kolor Tekstu",
"res_background" => "Tło",
"res_select_color" => "Wybierz Kolor",
"res_save" => "Uaktualnij Kategorię",
"res_added" => "Kategoria Dodana",
"res_updated" => "Kategoria Uaktualniona",
"res_deleted" => "Kategoria Usunięta",
"res_invalid_color" => "Color format invalid (#XXXXXX - X = HEX-value)",
"res_not_added" => "Kategoria Nie Dodana",
"res_not_updated" => "Kategoria Nie Uatualniona",
"res_not_deleted" => "Kategoria Nie Usunięta",
"res_nr" => "#",//
"res_repeat" => "Repeat",//
